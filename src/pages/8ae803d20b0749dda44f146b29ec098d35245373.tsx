 ...
 * 3D printing, laser cutting, embroidery, and vinyl/stickers.
 */
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Turn your 3D printer, laser cutter, embroidery machine, or vinyl cutter into income. List on PrintLoco and get matched with neighbors."
        path="/become-a-maker"
      />
      <Navbar />
          ...
          <div className="container grid gap-12 py-20 lg:grid-cols-2 lg:items-center lg:py-28">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg text-muted-foreground">
                Whether you 3D print, laser cut, embroider, or cut vinyl —
