...
const ServicePrinters = () => {
  ...
  const getServiceSamplePrinters = (count: number): PrinterListing[] => {
    ...
    return basePrinters.map((printer, index) => {
      ...
      } else if (serviceId === "cnc") {
        modifiedPrinter = {
          ...printer,
          brand: ["Shapeoko", "Nomad", "X-Carve", "MillOne", "Genmitsu"][index % 5],
          model: ["XXL", "883 Pro", "CNC", "CNC", "410"][index % 5],
          materials: ["Aluminum", "Wood", "Plastic", "Brass", "Copper"].slice(0, 2 + (index % 3)),
          has_ams: false,
          accepts_bulk: true,
          filament_colors: [],
        };
