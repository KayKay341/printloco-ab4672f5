...
const cards = [
  ...
  },
  {
    ...
    body: "Every zip code has its own maker community: events, design challenges, and skill-shares.",
  },
];
    ...
    <div className="container grid gap-12 lg:grid-cols-2 lg:items-center">
      <div className="relative">
        ...
        <div className="absolute -bottom-6 left-6 right-6 rounded-2xl border border-border bg-card p-5 shadow-card sm:left-auto sm:right-8 sm:max-w-xs">
          <div className="font-display text-3xl font-semibold text-accent">2,847</div>
          <div className="text-sm text-muted-foreground">free prints donated to schools and nonprofits this year</div>
        </div>
      </div>
      ...
      <div>
        ...
        <p className="mt-5 max-w-lg text-muted-foreground">
          PrintLocal isn't just a marketplace — it's neighborhood infrastructure. We invest a portion of every transaction back into your community.
        </p>
