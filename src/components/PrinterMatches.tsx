      ...
      <div className="mt-4 space-y-2">
        ...
        {top.map(({ p, distance, totalCost, turnaroundDays }) => (
          <Link
            key={p.id}
            to={`/printers/${p.id}`}
            className="group flex flex-col gap-2 rounded-md border border-slicer-border bg-slicer-panel-strong p-3 transition hover:border-slicer-cyan sm:flex-row sm:items-center sm:justify-between"
          >
